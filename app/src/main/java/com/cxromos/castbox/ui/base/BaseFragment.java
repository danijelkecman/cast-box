package com.cxromos.castbox.ui.base;
...
import com.cxromos.castbox.injection.component.DaggerConfigPersistentComponent;
import com.cxromos.castbox.injection.component.FragmentComponent;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!sComponentsMap.containsKey(mFragmentId)) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .applicationComponent(CastBoxApplication.get(getActivity()).getComponent())
                    .build();
